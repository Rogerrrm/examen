...
<body class="body-registergestor">
    <div class="modal-dialog text-center">
        <div class="col-sm-8 main-section">
            <div class="modal-content">
                ...
                <input type="hidden" name="r" value="doregistergestor">
                <a class="iniciarsession">REGISTRARSE COMO GESTOR</a><br><br>
                  <div class="form-group">
                    <label for="inputRol">Rol Usuario</label>
                    <select name="rol_user" class="form-control" id="inputRol" required>
